...
struct ProfileView: View {
    ...
    private let placeholderLists: [ListCardData] = [
        ListCardData(title: "All Spots",   count: 0, color: Color.gray400),
        ListCardData(title: "Starred",     count: 0, color: Color(red: 0.60, green: 0.50, blue: 0.30)),
        ListCardData(title: "Favorites",   count: 0, color: Color(red: 0.55, green: 0.30, blue: 0.30)),
        ListCardData(title: "Bucket List", count: 0, color: Color(red: 0.28, green: 0.45, blue: 0.60)),
    ]
    ...
    var body: some View {
        ...
        .onAppear { loadSpotsCount() }
    }

    private func loadSpotsCount() {
        Task {
            do {
    ...
    private var myListsSection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: 12) {
                    ForEach(placeholderLists, id: \.title) { list in
                        listCard(list)
                    }
                }
                .padding(.horizontal, 20)
    ...
    private func listCard(_ list: ListCardData) -> some View {
