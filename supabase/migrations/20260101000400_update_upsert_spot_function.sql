...
-- Drop prior 8-arg overload so the trailing COMMENT ON FUNCTION is unambiguous.
DROP FUNCTION IF EXISTS public.upsert_spot(TEXT, TEXT, TEXT, DOUBLE PRECISION, DOUBLE PRECISION, TEXT[], TEXT, TEXT);
